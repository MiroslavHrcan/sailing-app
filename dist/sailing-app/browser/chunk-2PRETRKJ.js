...
var TripService = class _TripService {
  STORAGE_KEY = "sailing_trips";
  ACTIVE_KEY = "sailing_active_trip";
  trips = signal(this.loadFromStorage());
  activeTripId = signal(localStorage.getItem(this.ACTIVE_KEY) || null);
  setActiveTrip(id) {
  ...
  add(data) {
    const trip = __spreadProps(__spreadValues({}, data), {
  ...
  update(id, data) {
    ...
    this.trips.update((list) => list.map((t) => {
      if (t.id !== id)
        return t;
      updated = __spreadValues(__spreadValues({}, t), data);
      return updated;
    }));
    if (updated)
      this.persist();
...
//# sourceMappingURL=chunk-2PRETRKJ.js.map
