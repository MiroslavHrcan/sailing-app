...
// src/app/features/weather/weather.component.ts
var _forTrack0 = ($index, $item) => $item.value;
var _forTrack1 = ($index, $item) => $item.id;
function WeatherComponent_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "wind_power");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, "\xA0Forecast Map ");
  }
}
function WeatherComponent_For_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-button-toggle", 10)(1, "mat-icon");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", o_r2.value)("matTooltip", o_r2.label);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(o_r2.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(o_r2.label);
  }
}
function WeatherComponent_ng_template_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "radar");
    \u0275\u0275elementEnd();
...
function WeatherComponent_ng_template_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "warning");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, "\xA0Warnings ");
  }
}
function WeatherComponent_Conditional_51_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Updated ", \u0275\u0275pipeBind2(2, 1, ctx_r3.weatherService.warningsUpdatedAt(), "HH:mm"), " \xA0\xB7\xA0 auto-refreshes every 15 min ");
  }
}
function WeatherComponent_Conditional_72_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31);
    \u0275\u0275element(1, "mat-spinner", 35);
    \u0275\u0275elementStart(2, "span");
    \u0275\u0275text(3, "Loading warnings...");
    \u0275\u0275elementEnd()();
  }
}
function WeatherComponent_Conditional_73_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function WeatherComponent_Conditional_73_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.refreshWarnings());
    });
    \u0275\u0275text(6, "Retry");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r3.weatherService.warningsError());
  }
}
function WeatherComponent_Conditional_74_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("No active weather warnings for ", ctx_r3.weatherService.hvarOnly() ? "the Hvar area" : "Croatia", "");
  }
}
function WeatherComponent_Conditional_75_For_2_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", w_r6.regions.join(", "), " ");
  }
}
function WeatherComponent_Conditional_75_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, WeatherComponent_Conditional_75_For_2_Conditional_10_Template, 4, 1, "div", 44);
    \u0275\u0275elementStart(11, "div", 45)(12, "span")(13, "mat-icon");
    \u0275\u0275text(14, "schedule");
    \u0275\u0275elementEnd();
    \u0275\u0275text(15);
    \u0275\u0275pipe(16, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "span")(18, "mat-icon");
    \u0275\u0275text(19, "timer_off");
    \u0275\u0275elementEnd();
    \u0275\u0275text(20);
    \u0275\u0275pipe(21, "date");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("border-left-color", ctx_r3.severityColors[w_r6.severity]);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", w_r6.severity);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(w_r6.severity);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(w_r6.type);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(w_r6.country);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(w_r6.headline);
    \u0275\u0275advance();
    \u0275\u0275conditional(w_r6.regions.length > 0 ? 10 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" From: ", \u0275\u0275pipeBind2(16, 10, w_r6.onset, "d MMM HH:mm"), "");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" Until: ", \u0275\u0275pipeBind2(21, 13, w_r6.expires, "d MMM HH:mm"), "");
  }
}
function WeatherComponent_Conditional_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34);
    \u0275\u0275repeaterCreate(1, WeatherComponent_Conditional_75_For_2_Template, 22, 16, "div", 37, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r3.weatherService.warnings());
  }
}
function WeatherComponent_For_77_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const page_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(page_r8.icon);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("\xA0", page_r8.title, " ");
  }
}
function WeatherComponent_For_77_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "iframe", 49);
    \u0275\u0275pipe(1, "safeUrl");
    \u0275\u0275listener("load", function WeatherComponent_For_77_Conditional_9_Template_iframe_load_0_listener($event) {
      \u0275\u0275restoreView(_r9);
      const page_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onIframeLoad($event, page_r8.id));
    })("error", function WeatherComponent_For_77_Conditional_9_Template_iframe_error_0_listener($event) {
      \u0275\u0275restoreView(_r9);
      const page_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onIframeError($event, page_r8.id));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const page_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275propertyInterpolate("title", page_r8.title);
    \u0275\u0275property("src", \u0275\u0275pipeBind1(1, 2, page_r8.url), \u0275\u0275sanitizeResourceUrl);
  }
}
function WeatherComponent_For_77_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 48)(1, "mat-icon", 50);
    \u0275\u0275text(2, "lock");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h3");
    \u0275\u0275text(4, "Cannot embed this page");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6, "The DHMZ website blocks embedding via security policy (X-Frame-Options).");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 51);
    \u0275\u0275listener("click", function WeatherComponent_For_77_Conditional_10_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r10);
      const page_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openExternal(page_r8.url));
    });
  ...
  if (rf & 2) {
    const page_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" Open ", page_r8.title, " on meteo.hr ");
  }
}
function WeatherComponent_For_77_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-tab");
    \u0275\u0275template(1, WeatherComponent_For_77_ng_template_1_Template, 3, 2, "ng-template", 4);
    \u0275\u0275elementStart(2, "div", 5)(3, "div", 46)(4, "span", 7);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 18);
    \u0275\u0275listener("click", function WeatherComponent_For_77_Template_button_click_6_listener() {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(9, WeatherComponent_For_77_Conditional_9_Template, 2, 4, "iframe", 47)(10, WeatherComponent_For_77_Conditional_10_Template, 11, 1, "div", 48);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(page_r8.title);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(!ctx_r3.iframeBlocked[page_r8.id] ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.iframeBlocked[page_r8.id] ? 10 : -1);
  }
}
var WeatherComponent = class _WeatherComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WeatherComponent, selectors: [["app-weather"]], decls: 78, vars: 18, consts: [["radarImg", ""], [1, "page-container"], [1, "page-title"], ["animationDuration", "200ms"], ["mat-tab-label", ""], [1, "tab-content"], [1, "windy-header"], [1, "tab-title"], [1, "windy-controls"], ["aria-label", "Overlay", 3, "change", "value"], [3, "value", "matTooltip"], ["mat-icon-button", "", "matTooltip", "Open full Windy", 3, "click"], ["frameborder", "0", "allowfullscreen", "", "title", "Windy forecast map", 1, "windy-iframe", 3, "src"], [1, "radar-note"], [1, "radar-header"], [1, "radar-meta"], [1, "updated"], ["mat-icon-button", "", "matTooltip", "Refresh radar", 3, "click"], ["mat-icon-button", "", "matTooltip", "Open in new tab", 3, "click"], [1, "radar-image-wrap"], ["alt", "Debeljak radar", 1, "radar-image", 3, "error", "src"], [1, "warnings-header"], [1, "warnings-title-block"], [1, "updated-at"], [1, "warnings-actions"], ["aria-label", "Region filter", 3, "change", "value"], ["matTooltip", "Show warnings for Hvar / Dalmatia only", 3, "value"], [1, "overlay-label"], ["matTooltip", "Show all Croatia warnings", 3, "value"], ["mat-stroked-button", "", "matTooltip", "Fetch latest warnings now", 3, "click", "disabled"], ["mat-stroked-button", "", "href", "https://meteoalarm.org/en/live/warning/bf850bc6-8706-43d7-b74a-c9b346c1ef4e/27af5646-2309-4da7-8185-6d4e186c76cf", "target", "_blank", "rel", "noopener noreferrer", "matTooltip", "Open MeteoAlarm Croatia page"], [1, "loading-center"], [1, "error-box"], [1, "no-warnings"], [1, "warnings-list"], ["diameter", "40"], ["mat-stroked-button", "", 3, "click"], [1, "warning-card", 3, "border-left-color"], [1, "warning-card"], [1, "warning-header"], [1, "severity-chip", 3, "ngClass"], [1, "warning-type"], [1, "warning-country"], [1, "warning-headline"], [1, "warning-regions"], [1, "warning-times"], [1, "iframe-header"], [1, "meteo-iframe", 3, "src", "title"], [1, "iframe-fallback"], [1, "meteo-iframe", 3, "load", "error", "src", "title"], [1, "block-icon"], ["mat-flat-button", "", "color", "primary", 3, "click"]], template: function WeatherComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 1)(1, "h1", 2)(2, "mat-icon");
      \u0275\u0275text(3, "cloud");
      \u0275\u0275elementEnd();
      \u0275\u0275text(4, " Weather ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "mat-tab-group", 3)(6, "mat-tab");
      \u0275\u0275template(7, WeatherComponent_ng_template_7_Template, 3, 0, "ng-template", 4);
      \u0275\u0275elementStart(8, "div", 5)(9, "div", 6)(10, "span", 7);
      \u0275\u0275text(11, "Adriatic Forecast \u2014 Windy (ECMWF)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "div", 8)(13, "mat-button-toggle-group", 9);
      \u0275\u0275listener("change", function WeatherComponent_Template_mat_button_toggle_group_change_13_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.windyOverlay.set($event.value));
      });
      \u0275\u0275repeaterCreate(14, WeatherComponent_For_15_Template, 5, 4, "mat-button-toggle", 10, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "button", 11);
      \u0275\u0275listener("click", function WeatherComponent_Template_button_click_16_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.openExternal("https://www.windy.com/?43.5,16.4,7"));
      });
      \u0275\u0275elementStart(17, "mat-icon");
      \u0275\u0275text(18, "open_in_new");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275element(19, "iframe", 12);
      \u0275\u0275pipe(20, "safeUrl");
      \u0275\u0275elementStart(21, "p", 13);
      \u0275\u0275text(22, "Interactive ECMWF forecast map in knots. Switch overlays above. Powered by Windy.com.");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(23, "mat-tab");
      \u0275\u0275template(24, WeatherComponent_ng_template_24_Template, 3, 0, "ng-template", 4);
      \u0275\u0275elementStart(25, "div", 5)(26, "div", 14)(27, "span", 7);
      \u0275\u0275text(28, "Debeljak Radar \u2014 Adriatic");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function WeatherComponent_Template_button_click_33_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.refreshRadar());
      });
      \u0275\u0275elementStart(34, "mat-icon");
      \u0275\u0275text(35, "refresh");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(36, "button", 18);
      \u0275\u0275listener("click", function WeatherComponent_Template_button_click_36_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.openExternal("https://meteo.hr/podaci_e.php?section=podaci_mjerenja&param=radari&el=debeljak&acto=stat&it=13"));
      });
      \u0275\u0275elementStart(37, "mat-icon");
      \u0275\u0275text(38, "open_in_new");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(39, "div", 19)(40, "img", 20, 0);
      \u0275\u0275listener("error", function WeatherComponent_Template_img_error_40_listener() {
        \u0275\u0275restoreView(_r1);
        const radarImg_r3 = \u0275\u0275reference(41);
        return \u0275\u0275resetView(radarImg_r3.classList.add("error"));
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(42, "p", 13);
      \u0275\u0275text(43, "Auto-refreshes every 5 minutes. Showing reflectivity (dBz) from DHMZ Debeljak station.");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(44, "mat-tab");
      \u0275\u0275template(45, WeatherComponent_ng_template_45_Template, 3, 0, "ng-template", 4);
      \u0275\u0275elementStart(46, "div", 5)(47, "div", 21)(48, "div", 22)(49, "span", 7);
      \u0275\u0275text(50);
      \u0275\u0275elementEnd();
      \u0275\u0275template(51, WeatherComponent_Conditional_51_Template, 3, 4, "span", 23);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(52, "div", 24)(53, "mat-button-toggle-group", 25);
      \u0275\u0275listener("change", function WeatherComponent_Template_mat_button_toggle_group_change_53_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.weatherService.hvarOnly.set($event.value));
      });
      \u0275\u0275elementStart(54, "mat-button-toggle", 26)(55, "mat-icon");
      \u0275\u0275text(56, "place");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(57, "span", 27);
      \u0275\u0275text(58, "Hvar area");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(59, "mat-button-toggle", 28)(60, "mat-icon");
      \u0275\u0275text(61, "public");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(62, "span", 27);
      \u0275\u0275text(63, "All Croatia");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(64, "button", 29);
      \u0275\u0275listener("click", function WeatherComponent_Template_button_click_64_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.refreshWarnings());
      });
      ...
      \u0275\u0275text(67, " Refresh ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(68, "a", 30)(69, "mat-icon");
      \u0275\u0275text(70, "open_in_new");
      \u0275\u0275elementEnd();
      \u0275\u0275text(71, " meteoalarm.org ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(72, WeatherComponent_Conditional_72_Template, 4, 0, "div", 31)(73, WeatherComponent_Conditional_73_Template, 7, 1, "div", 32)(74, WeatherComponent_Conditional_74_Template, 5, 1, "div", 33)(75, WeatherComponent_Conditional_75_Template, 3, 0, "div", 34);
      \u0275\u0275elementEnd()();
      \u0275\u0275repeaterCreate(76, WeatherComponent_For_77_Template, 11, 3, "mat-tab", null, _forTrack1);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(13);
      \u0275\u0275property("value", ctx.windyOverlay());
      \u0275\u0275advance();
      \u0275\u0275repeater(ctx.windyOverlays);
      \u0275\u0275advance(5);
      \u0275\u0275property("src", \u0275\u0275pipeBind1(20, 13, ctx.windyUrl()), \u0275\u0275sanitizeResourceUrl);
      \u0275\u0275advance(12);
      \u0275\u0275textInterpolate1("Updated: ", \u0275\u0275pipeBind2(32, 15, ctx.weatherService.radarUpdatedAt(), "HH:mm"), "");
      \u0275\u0275advance(9);
      \u0275\u0275property("src", ctx.weatherService.radarUrl(), \u0275\u0275sanitizeUrl);
      \u0275\u0275advance(10);
      \u0275\u0275textInterpolate1(" MeteoAlarm \u2014 ", ctx.weatherService.hvarOnly() ? "Hvar Area" : "All Croatia (HR)", " ");
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.weatherService.warningsUpdatedAt() ? 51 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275property("value", ctx.weatherService.hvarOnly());
      \u0275\u0275advance();
      \u0275\u0275property("value", true);
      \u0275\u0275advance(5);
      \u0275\u0275property("value", false);
      \u0275\u0275advance(5);
      \u0275\u0275property("disabled", ctx.weatherService.warningsLoading());
      \u0275\u0275advance();
      \u0275\u0275classProp("spinning", ctx.weatherService.warningsLoading());
      \u0275\u0275advance(7);
      \u0275\u0275conditional(ctx.weatherService.warningsLoading() ? 72 : ctx.weatherService.warningsError() ? 73 : ctx.weatherService.warnings().length === 0 ? 74 : 75);
      \u0275\u0275advance(4);
      \u0275\u0275repeater(ctx.meteoPages);
    }
  }, dependencies: [MatTabsModule, MatTabLabel, MatTab, MatTabGroup, MatButtonModule, MatAnchor, MatButton, MatIconButton, MatButtonToggleModule, MatButtonToggleGroup, MatButtonToggle, MatIconModule, MatIcon, MatProgressSpinnerModule, MatProgressSpinner, MatTooltipModule, MatTooltip, SafeUrlPipe, DatePipe, NgClass], styles: ["\n\n.tab-content[_ngcontent-%COMP%] {\n  padding: 16px 0;\n}\n.tab-title[_ngcontent-%COMP%] {\n  font-size: 1rem;\n  font-weight: 600;\n  color: var(--color-gold-light);\n}\n.windy-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 12px;\n  flex-wrap: wrap;\n  gap: 10px;\n}\n.windy-controls[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  flex-wrap: wrap;\n}\n.windy-controls[_ngcontent-%COMP%]   mat-button-toggle-group[_ngcontent-%COMP%] {\n  background: rgba(26, 58, 92, 0.6);\n  border: 1px solid rgba(212, 160, 23, 0.3);\n  border-radius: 4px;\n}\n.windy-controls[_ngcontent-%COMP%]   mat-button-toggle[_ngcontent-%COMP%] {\n  color: var(--color-text-dim);\n  font-size: 0.75rem;\n}\n.windy-controls[_ngcontent-%COMP%]   mat-button-toggle.mat-button-toggle-checked[_ngcontent-%COMP%] {\n  background: rgba(212, 160, 23, 0.2);\n  color: var(--color-gold-light);\n}\n.overlay-label[_ngcontent-%COMP%] {\n  margin-left: 4px;\n}\n@media (max-width: 600px) {\n  .overlay-label[_ngcontent-%COMP%] {\n    display: none;\n  }\n}\n.windy-iframe[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 600px;\n  border: none;\n  border-radius: 8px;\n}\n@media (max-width: 600px) {\n  .windy-iframe[_ngcontent-%COMP%] {\n    height: 400px;\n  }\n}\n.radar-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 12px;\n  flex-wrap: wrap;\n  gap: 8px;\n}\n.radar-meta[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n}\n.radar-meta[_ngcontent-%COMP%]   .updated[_ngcontent-%COMP%] {\n  color: var(--color-text-dim);\n  font-size: 0.85rem;\n}\n.radar-image-wrap[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  background: #0e1f3a;\n  border-radius: 8px;\n  padding: 8px;\n  border: 1px solid rgba(212, 160, 23, 0.2);\n  min-height: 300px;\n  align-items: center;\n}\n.radar-image[_ngcontent-%COMP%] {\n  max-width: 100%;\n  max-height: 500px;\n  border-radius: 4px;\n}\n.radar-image.error[_ngcontent-%COMP%] {\n  display: none;\n}\n.radar-note[_ngcontent-%COMP%] {\n  color: var(--color-text-dim);\n  font-size: 0.8rem;\n  margin-top: 8px;\n}\n.warnings-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  margin-bottom: 16px;\n  flex-wrap: wrap;\n  gap: 8px;\n}\n.warnings-title-block[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.updated-at[_ngcontent-%COMP%] {\n  font-size: 0.75rem;\n  color: var(--color-text-dim);\n}\n@keyframes _ngcontent-%COMP%_spin {\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n}\n.spinning[_ngcontent-%COMP%] {\n  animation: _ngcontent-%COMP%_spin 1s linear infinite;\n  display: inline-block;\n}\n.warnings-actions[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 8px;\n  align-items: center;\n}\n.loading-center[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 12px;\n  padding: 32px;\n  color: var(--color-text-dim);\n}\n.error-box[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 16px;\n  background: rgba(244, 67, 54, 0.1);\n  border: 1px solid rgba(244, 67, 54, 0.3);\n  border-radius: 8px;\n  color: #ef9a9a;\n}\n.error-box[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: #f44336;\n}\n.no-warnings[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 24px;\n  background: rgba(76, 175, 80, 0.1);\n  border: 1px solid rgba(76, 175, 80, 0.3);\n  border-radius: 8px;\n  color: #a5d6a7;\n}\n.no-warnings[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: #4caf50;\n}\n.warnings-list[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n.warning-card[_ngcontent-%COMP%] {\n  background: var(--card-bg);\n  border: 1px solid rgba(212, 160, 23, 0.2);\n  border-left: 4px solid;\n  border-radius: 8px;\n  padding: 12px 16px;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.warning-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  flex-wrap: wrap;\n}\n.warning-type[_ngcontent-%COMP%] {\n  font-weight: 600;\n  color: var(--color-white);\n}\n.warning-country[_ngcontent-%COMP%] {\n  color: var(--color-text-dim);\n  font-size: 0.8rem;\n  background: rgba(255, 255, 255, 0.08);\n  padding: 1px 8px;\n  border-radius: 10px;\n}\n.warning-headline[_ngcontent-%COMP%] {\n  color: var(--color-white);\n  font-size: 0.9rem;\n}\n.warning-regions[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  color: var(--color-text-dim);\n  font-size: 0.8rem;\n}\n.warning-regions[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 0.9rem;\n  width: 0.9rem;\n  height: 0.9rem;\n}\n.warning-times[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 16px;\n  flex-wrap: wrap;\n  color: var(--color-text-dim);\n  font-size: 0.8rem;\n}\n.warning-times[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n}\n.warning-times[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 0.9rem;\n  width: 0.9rem;\n  height: 0.9rem;\n}\n.iframe-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 8px;\n}\n.meteo-iframe[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 600px;\n  border: none;\n  border-radius: 8px;\n  background: #fff;\n}\n.iframe-fallback[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 12px;\n  padding: 48px;\n  background: var(--card-bg);\n  border: 1px solid rgba(212, 160, 23, 0.2);\n  border-radius: 8px;\n  text-align: center;\n  color: var(--color-text-dim);\n}\n.iframe-fallback[_ngcontent-%COMP%]   .block-icon[_ngcontent-%COMP%] {\n  font-size: 3rem;\n  width: 3rem;\n  height: 3rem;\n  color: var(--color-gold);\n}\n.iframe-fallback[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  color: var(--color-white);\n  margin: 0;\n}\n/*# sourceMappingURL=weather.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(WeatherComponent, [{
    type: Component,
    args: [{ selector: "app-weather", standalone: true, imports: [
      MatTabsModule,
      MatButtonModule,
      MatButtonToggleModule,
      MatIconModule,
          ...
          <div class="warnings-title-block">
            ...
            @if (weatherService.warningsUpdatedAt()) {
              <span class="updated-at">
                ...
                &nbsp;\xB7&nbsp; auto-refreshes every 15 min
              </span>
            }
          </div>
...
`, styles: ["/* src/app/features/weather/weather.component.scss */\n.tab-content {\n  padding: 16px 0;\n}\n.tab-title {\n  font-size: 1rem;\n  font-weight: 600;\n  color: var(--color-gold-light);\n}\n.windy-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 12px;\n  flex-wrap: wrap;\n  gap: 10px;\n}\n.windy-controls {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  flex-wrap: wrap;\n}\n.windy-controls mat-button-toggle-group {\n  background: rgba(26, 58, 92, 0.6);\n  border: 1px solid rgba(212, 160, 23, 0.3);\n  border-radius: 4px;\n}\n.windy-controls mat-button-toggle {\n  color: var(--color-text-dim);\n  font-size: 0.75rem;\n}\n.windy-controls mat-button-toggle.mat-button-toggle-checked {\n  background: rgba(212, 160, 23, 0.2);\n  color: var(--color-gold-light);\n}\n.overlay-label {\n  margin-left: 4px;\n}\n@media (max-width: 600px) {\n  .overlay-label {\n    display: none;\n  }\n}\n.windy-iframe {\n  width: 100%;\n  height: 600px;\n  border: none;\n  border-radius: 8px;\n}\n@media (max-width: 600px) {\n  .windy-iframe {\n    height: 400px;\n  }\n}\n.radar-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 12px;\n  flex-wrap: wrap;\n  gap: 8px;\n}\n.radar-meta {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n}\n.radar-meta .updated {\n  color: var(--color-text-dim);\n  font-size: 0.85rem;\n}\n.radar-image-wrap {\n  display: flex;\n  justify-content: center;\n  background: #0e1f3a;\n  border-radius: 8px;\n  padding: 8px;\n  border: 1px solid rgba(212, 160, 23, 0.2);\n  min-height: 300px;\n  align-items: center;\n}\n.radar-image {\n  max-width: 100%;\n  max-height: 500px;\n  border-radius: 4px;\n}\n.radar-image.error {\n  display: none;\n}\n.radar-note {\n  color: var(--color-text-dim);\n  font-size: 0.8rem;\n  margin-top: 8px;\n}\n.warnings-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  margin-bottom: 16px;\n  flex-wrap: wrap;\n  gap: 8px;\n}\n.warnings-title-block {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.updated-at {\n  font-size: 0.75rem;\n  color: var(--color-text-dim);\n}\n@keyframes spin {\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n}\n.spinning {\n  animation: spin 1s linear infinite;\n  display: inline-block;\n}\n.warnings-actions {\n  display: flex;\n  gap: 8px;\n  align-items: center;\n}\n.loading-center {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 12px;\n  padding: 32px;\n  color: var(--color-text-dim);\n}\n.error-box {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 16px;\n  background: rgba(244, 67, 54, 0.1);\n  border: 1px solid rgba(244, 67, 54, 0.3);\n  border-radius: 8px;\n  color: #ef9a9a;\n}\n.error-box mat-icon {\n  color: #f44336;\n}\n.no-warnings {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 24px;\n  background: rgba(76, 175, 80, 0.1);\n  border: 1px solid rgba(76, 175, 80, 0.3);\n  border-radius: 8px;\n  color: #a5d6a7;\n}\n.no-warnings mat-icon {\n  color: #4caf50;\n}\n.warnings-list {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n.warning-card {\n  background: var(--card-bg);\n  border: 1px solid rgba(212, 160, 23, 0.2);\n  border-left: 4px solid;\n  border-radius: 8px;\n  padding: 12px 16px;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.warning-header {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  flex-wrap: wrap;\n}\n.warning-type {\n  font-weight: 600;\n  color: var(--color-white);\n}\n.warning-country {\n  color: var(--color-text-dim);\n  font-size: 0.8rem;\n  background: rgba(255, 255, 255, 0.08);\n  padding: 1px 8px;\n  border-radius: 10px;\n}\n.warning-headline {\n  color: var(--color-white);\n  font-size: 0.9rem;\n}\n.warning-regions {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  color: var(--color-text-dim);\n  font-size: 0.8rem;\n}\n.warning-regions mat-icon {\n  font-size: 0.9rem;\n  width: 0.9rem;\n  height: 0.9rem;\n}\n.warning-times {\n  display: flex;\n  gap: 16px;\n  flex-wrap: wrap;\n  color: var(--color-text-dim);\n  font-size: 0.8rem;\n}\n.warning-times span {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n}\n.warning-times span mat-icon {\n  font-size: 0.9rem;\n  width: 0.9rem;\n  height: 0.9rem;\n}\n.iframe-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 8px;\n}\n.meteo-iframe {\n  width: 100%;\n  height: 600px;\n  border: none;\n  border-radius: 8px;\n  background: #fff;\n}\n.iframe-fallback {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 12px;\n  padding: 48px;\n  background: var(--card-bg);\n  border: 1px solid rgba(212, 160, 23, 0.2);\n  border-radius: 8px;\n  text-align: center;\n  color: var(--color-text-dim);\n}\n.iframe-fallback .block-icon {\n  font-size: 3rem;\n  width: 3rem;\n  height: 3rem;\n  color: var(--color-gold);\n}\n.iframe-fallback h3 {\n  color: var(--color-white);\n  margin: 0;\n}\n/*# sourceMappingURL=weather.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WeatherComponent, { className: "WeatherComponent", filePath: "src/app/features/weather/weather.component.ts", lineNumber: 34 });
})();
export {
  WeatherComponent
};
//# sourceMappingURL=chunk-B64R3QYX.js.map
